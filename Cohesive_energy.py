...
def Cohesive_energy(unit_cell: str = "LiCl.cif", single_molecule: str = "LiCl_molecule.cif", base_name: str = "LiCl"):
    ...
    print(
        f"Normalized cohesive energy of {base_name}: {E_cohesive}")
    return E_cohesive
...
def plot_cohesive_energy(unitcells: list = ["chgnet/MyCHGNetCode/cif_files_halides/TiBr4_mp-569814_computed.cif"], molecules: list = ["chgnet/MyCHGNetCode/Cohesive_cifs/TiBr4_molecule.cif"], labels: list = ["TiBr4"]):
    ...
    """
    cohesive_energies = []
    for unitcell, molecule, label in zip(unitcells, molecules, labels):
        cohesive_energies.append(
            Cohesive_energy(unit_cell=unitcell, single_molecule=molecule, base_name=label))
...
plot_cohesive_energy(["chgnet/MyCHGNetCode/cif_files_halides/TiBr4_mp-569814_computed.cif",
                      ...
                      "chgnet/MyCHGNetCode/cif_files_halides/GeBr4_mp-567604_computed.cif",
                      "chgnet/MyCHGNetCode/cif_files_halides/PtF6_mp-505319_computed.cif"],[
                          "chgnet/MyCHGNetCode/Cohesive_cifs/TiBr4_molecule.cif",
                          "chgnet/MyCHGNetCode/Cohesive_cifs/WCl6_molecule.cif",
                          "chgnet/MyCHGNetCode/Cohesive_cifs/GeBr4_molecule.cif",
                          "chgnet/MyCHGNetCode/Cohesive_cifs/PtF6_molecule.cif"],[
                              "TiBr4","WCl6", "GeBr4", "PtF6"
                          ])
...
# # hexaCl = molecule('UCl6')
# # hexaCl.write('UCl6_molecule.cif')

# from ase.data.pubchem import pubchem_atoms_search
# formamide = pubchem_atoms_search(name='formamide') # use chemical name\n"
# UCl_ = pubchem_atoms_search(smiles='[Cl-].[Cl-].[Cl-].[Cl-].[Cl-].[Cl-].[U]')